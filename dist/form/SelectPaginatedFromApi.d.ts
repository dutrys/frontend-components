...
export declare const SelectPaginatedFromApi: <TModel extends {
    meta: ResponseMeta;
    data: unknown[];
}>({ onChange, name, value, searchFromChars, queryKey, queryFn, optionLabel, optionValue, ...rest }: Omit<React.SelectHTMLAttributes<HTMLSelectElement>, "size" | "multiple" | "defaultValue" | "type" | "value" | "children"> & SelectPaginatedFromApiProps<TModel>) => import("react/jsx-runtime").JSX.Element;
