...
export const NumberInput = ({ options, ...props }) => (_jsxs("div", { children: [_jsxs("div", { className: "floating-label", children: [!props?.disabled && (_jsxs("span", { children: [props.label, props?.required && _jsx(Required, {})] })), _jsx(Controller, { name: props.name, control: props.control, render: ({ field }) => (_jsx(NumericFormat, { placeholder: props.label, ...options, disabled: props?.disabled, required: props?.required, value: field.value, className: `${props.size === "sm" ? "input-sm " : ""}w-full input input-bordered focus:outline-blue-400`, onValueChange: (values) => field.onChange(values.floatValue) })) })] }), props.desc && _jsx("div", { className: "text-xs text-gray-500", children: props.desc }), props.error && _jsx(InputErrors, { className: "text-xs text-error mt-1", errors: props.error })] }));
